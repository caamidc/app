...
public class Salones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        obtenerEmpresasSalones();

        // Listener para manejar la selección de un salón y mostrar los detalles
        listViewSalones.setOnItemClickListener((parent, view, position, id) -> {
            ...
            // Hacemos una consulta a Firestore para obtener los detalles del salón seleccionado
            db.collection("prestadores")
                    ...
                    .addOnSuccessListener(documentSnapshot -> {
                        if (documentSnapshot.exists()) {
                            ...
                            Toast.makeText(this, "No se encontraron detalles para este salón", Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void obtenerEmpresasSalones() {
        db.collection("prestadores")
                .document("empresa")
                .collection("Empresa")
                .whereEqualTo("categoria", "Salones de belleza")
                .get()
