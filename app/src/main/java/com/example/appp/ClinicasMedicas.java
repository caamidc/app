...
public class ClinicasMedicas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        obtenerEmpresasClinicas();

        // Listener para manejar la selección de una clínica y mostrar los detalles
        listViewClinicas.setOnItemClickListener((parent, view, position, id) -> {
            ...
            // Hacemos una consulta a Firestore para obtener los detalles de la clínica seleccionada
            db.collection("prestadores")
                    ...
                    .addOnSuccessListener(documentSnapshot -> {
                        if (documentSnapshot.exists()) {
                            ...
                            Toast.makeText(this, "No se encontraron detalles para esta clínica", Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void obtenerEmpresasClinicas() {
        db.collection("prestadores")
                .document("empresa")
                .collection("Empresa")
                .whereEqualTo("categoria", "Clínicas Médicas")
                .get()
