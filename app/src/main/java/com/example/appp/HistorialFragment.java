    ...
    public class HistorialFragment extends Fragment {
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            adapter = new ArrayAdapter<>(getContext(), android.R.layout.simple_list_item_1, listaReservas);
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                // Crear un string descriptivo de la reserva
                                String reservaInfo = "Empresa: " + nombreEmpresa + "\nUbicación: " + ubicacion +
                                        "\nHorario: " + horario + "\nContacto: " + contacto;

                                listaReservas.add(reservaInfo);  // Agregamos la reserva a la lista
                            }
